              ...
              <div className="pt-2 border-t border-gray-100">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    ...
                    <button
                      onClick={addSkill}
                      className="px-4 h-11 text-sm font-medium text-white rounded-xl cursor-pointer hover:opacity-90 transition-all shrink-0"
                      style={{
                  ...
                  {skills.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {skills.map((skill) => (
                        <span
                          key={skill}
                          className="flex items-center gap-1.5 text-xs font-medium bg-indigo-50 text-indigo-600 px-3 py-1.5 rounded-full"
                        >
                          {skill}
                          <button
