...
const NotificationBell = () => {
  ...
  // Total badge = polled DB count + real-time arrivals since last open
  const totalUnread = polledUnreadCount + unreadNotificationCount;

  // Poll unread count from DB on mount
  useEffect(() => {
    ...
    fetchCount();
    const interval = setInterval(fetchCount, 60000); // poll every 60s as fallback
