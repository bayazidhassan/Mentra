...
import { TAdminRecentSession, TAdminStats } from '../../../lib/services/admin';
...
type Props = {
  ...
  recentSessions: TAdminRecentSession[];
};

const AdminDashboardClientPage = ({ stats, recentSessions }: Props) => {
