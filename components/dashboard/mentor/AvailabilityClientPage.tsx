...
type Props = {
  initialAvailability: TAvailability[];
...
const AvailabilityClientPage = ({
  initialAvailability,
  initialHourlyRate,
}: Props) => {
  const [slots, setSlots] = useState<TAvailability[]>(initialAvailability);
  ...
  const [initialRate, setInitialRate] = useState<string>(initialHourlyRate);
